...
{
    /**
     * Static description of a Hashi puzzle.
     *
     * @author James Echmalian, ech@ech.net
     */
    public class HashiConfig
    {
         ...
         * Load from XML.
         */
        public function HashiConfig(xml:XML)
        {
            _xml = xml.copy();
        }
         ...
         * Clone this.
         */
        public function copy():HashiConfig
        {
            return new HashiConfig(_xml);
        }
